...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <p class="d-flex justify-content-center font-weight-bold text-uppercase mt-4 titleWelcolme">Appointment details</p>
            </div>
        </div>
        ...
        <div class="row justify-content-center">
            ...
            <?php
            // Condition pour ne plus afficher le formulaire quand le rendez-vous a bien été enregistré
            if ($detailsAppointmentArray) {
            include 'include/details-appointment.php';
            // Si erreur, nous indiquons à l'utilisateur que le patient n'est pas présent
                } else { ?>
            <div>
                <p class="h5 text-danger text-center mb-3"></i>This appointment doesn't exist.</p>
                <div class="text-center">
                    <a type="button" href="view-addAppointments.php" class="btn btn-sm btn-outline-secondary">CLICK HERE FOR ADD NEW APPOINTMENT</a>
                </div>
            </div>
            <?php } ?>
        ...
        <div class="mt-3 mb-3 d-flex justify-content-center">
            <a type="button" href="../views/view-listAppointments.php" class="btn btnConnexion mr-1">back appointment list</a>
        </div>

...
<head>
    <title>CRUD | Add new appointment</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
...
<body>
    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            ...
            <!-- Si le rendez-vous n'est pas enregistré, message prévenant l'utilisateur -->
            <p class="h5 text-center text-danger"><?= $messages['addAppointement'] ?? '' ?></p>
            <?php
    
            // Mise en place du formulaire grâce au include
            include 'include/form-addAppointments.php';
                } else { ?>
            <!-- Si le rendez-vous a bien été enregistré, message prévenant l'utilisateur -->
            <div>
                <p class="h4 mt-5 text-center text-info"><?= $messages['addAppointement'] ?? '' ?></p>
                <div class="mt-5 d-flex justify-content-center">
                    <a type="button" href="view-addAppointments.php" class="btn btnConnexion mr-1">add another appointment</a>
                    <a type="button" href="view-listAppointments.php" class="btn btnConnexion ml-1">appointments list</a>
                </div>
            </div>
            <?php } ?>
